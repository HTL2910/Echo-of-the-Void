...
- [ ] [2026-09-24] **Slice sprite HD sheets trong Sprite Editor** | `Assets/Art/Sprites/Kael/spr_kael_sheet_HD.png` + enemies/boss/tileset/HUD | Commit 14e190a có HD sheets mới (4x4 grid, 256x256) nhưng chưa slice để tạo sub-sprites. Sau khi slice, Claude sẽ update `SceneGenerator.cs` (line 164) từ individual frames cũ sang HD sheets sliced mới, rồi regenerate scene + test 129 case.
