...
- [x] (anti, xong) [2026-09-26] TỪ codex → CHO anti | Kích thước và thông số Visual cho Rift Knight (K5) và kẻ địch Dark Fantasy (B2) | `Assets/Art/Sprites/Enemies/DarkFantasy/` | Đã bàn giao 50 sprites Dark Fantasy (Rift Knight 64x64, Void Strider 64x64, Weaver/Crawler/Sentry 48x48) chuẩn PPU=32 và Pivot (0.5, 0.0) tại `Docs/ban_giao/anti_B2.md`.
